...
class Experiment:
    ...
    def train(self, args):
        ...
        if args.gsl_mode == 'structure_refinement':
            ...
            features, nfeats, labels, nclasses, train_mask, val_mask, test_mask, _ = load_data2(args, '2') 
        ...
        for trial in range(args.ntrials):
            ...
            for epoch in range(1, args.epochs + 1):
                ...
                loss, Adj, TempFeature = self.loss_gcl(model, graph_learner, features, anchor_adj)
            ...
            if args.downstream_task == 'classification':
                ...
                df = pd.DataFrame(best_TempFeature.cpu().detach().numpy().tolist()) 
                df.to_csv('./best_TempFeature.csv')  
                #best_TempFeature
            elif args.downstream_task == 'clustering':
                print("Final ACC: ", acc)
                print("Final NMI: ", nmi)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-rep_dim', type=int, default=16)      
    ...
    parser.add_argument('-dropedge_rate', type=float, default=0.001) 
